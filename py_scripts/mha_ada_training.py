#!/usr/bin/env python3
"""MHA-ADA Training: Audio Deepfake Attribution — multi-class classification by source dataset."""
...
class AudioDeepfakeAttributionModel(nn.Module):
    """MHA-ADA model: pretrained encoder + attention + 3-class classifier."""
...
def train_model(model, train_loader, val_loader, device, epochs=20, lr=1e-4,
                save_path="models/MHA_ADA_model.pt", checkpoint_dir="checkpoints/MHA_ADA",
...
def main():
    ...
    parser.add_argument("--save-path", type=str, default="/ocean/projects/cis260121p/shared/models/MHA_ADA_model.pt")
    parser.add_argument("--csv-dir", type=str, default="/ocean/projects/cis260121p/shared/csv/MHA_ADA_split")
    parser.add_argument("--checkpoint-dir", type=str, default="/ocean/projects/cis260121p/shared/checkpoints/MHA_ADA")
    ...
    conf_csv = os.path.join(args.working_dir, "csv/MHA_ADA/confidence_scores.csv")
    ...
    evaluate_and_plot(
        ...
        loader=test_loader,
        device=device,
        report_path=os.path.join(args.working_dir, "reports/MHA_ADA_test_report.csv"),
        plot_dir=os.path.join(args.working_dir, "plots/MHA_ADA/"),
    )
